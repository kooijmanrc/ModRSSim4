...
CString csNewTitle, portName;
   ...
   switch (protocol)
   {
      ...
      case PROTOCOL_SELMODETH_RTU:
         ...
         m_pServerSockArray->AddServers(protocol,
										m_numServers, 
                                        m_localPort, 
                                        m_responseDelay, 
                                        m_linger, 
         ...
         m_pServerSockArray->AddSimServer(5030);
         break;
      default: 
         ASSERT(0);
         break;
...
SOCKET peerSock = INVALID_SOCKET;
   ...
   if (!m_pServerSockArray)  // user has closed the port //nlrkooi -> perhaps make generic: include array in fun 
   {
