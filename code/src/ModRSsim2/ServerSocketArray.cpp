...
LONG CServerSocketArray::AddSimServer(int port)
{

    CMODEthCommsProcessor* pServer;
    int responseDelay = 0; 
    BOOL MOSCADchecks = FALSE;
    BOOL modifyThenRespond = FALSE;
    BOOL disableWrites = FALSE;
    LONG PDUSize = 2000;
    DWORD protocol = PROTOCOL_SELSIM;
...
// ------------------------- AddServers ------------------------------------
// Start all the servers you want
LONG CServerSocketArray::AddServers(DWORD protocol,
									int numServers, 
                                    int port, 
                                    int responseDelay, 
                                    BOOL linger,
